...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        private void CalculateGearFactor()
        {
            ...
            m_GearFactor = Mathf.Lerp(m_GearFactor, targetGearFactor, Time.deltaTime*10f);
        }
        ...
        public void Move(float steering, float accel, float footbrake, float handbrake)
        {
            ...
            hb = handbrake;
            if (nitroPressed && accel > 0.7f && accel < 0.9f)
            {
                m_Rigidbody.AddExplosionForce(nitroBoost, nitroPoint.position, 5);
        ...
        private void ApplyDrive(float accel, float footbrake)
        {
            ...
            switch (m_CarDriveType)
            {
                case CarDriveType.FourWheelDrive:
                    ...
                    if (nitroPressed)
                    {
                        m_Rigidbody.mass = 300;
                        m_Topspeed = 80;
                        leftJet.gameObject.SetActive(true);
                        rightJet.gameObject.SetActive(true);
                    ...
                    else
                    {
                        ...
                        m_Topspeed = 30;
                        leftJet.gameObject.SetActive(false);
                        rightJet.gameObject.SetActive(false);
                    }
